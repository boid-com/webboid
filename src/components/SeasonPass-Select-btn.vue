<template lang="pug">
q-card.cursor-pointer.relative-position.shadow-6(v-ripple="{ color: 'green' }" style="margin:10px; padding:0px; min-width:100px; zoom: 1; border-radius: 20px; user-select:none;" :class="{selectedpay:selectedPay === coin.symbol}" @click="updateSelectedPay(coin.symbol)")
