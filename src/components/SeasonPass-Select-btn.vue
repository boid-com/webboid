<template lang="pug">
div.cursor-pointer.relative-position.shadow-2(v-ripple style="margin:10px; padding:0px; width:130px; height:140px; zoom: 1; border-radius:30px; user-select:none;" :class="{selectedpay:selectedPay === coin.symbol}" @click="updateSelectedPay(coin.symbol)")
