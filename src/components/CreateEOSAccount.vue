      ...
      q-card.relative-position(style="height:100%;")
        div
          div(style="margin-bottom:20px;")
            .row.justify-center
              p.light-paragraph.text-center.no-margin EOS Name Service
            .row.justify-center
              small Easy account creation right here on this page.
            //- .row
            //-   .col-4
        ...
        .row
          iframe(width="100%" style="min-height:600px;" src="https://eosnameservice.io/?ref=boidaccounts&widget=true")
